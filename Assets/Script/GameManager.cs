...
public class GameManager : MonoBehaviour
{
    ...
    public int gun,sniper,Deaths,dstryed;
    ...
    public Text bullet, health, kills, helicopterDestroyed;
   ...
   // public GameObject Retry;
    void FixedUpdate()
    {
        ...
        if(Input.GetKey(KeyCode.V) && Pause==false && m<=0)
        {
            Kit();
            m=1;
        }
   ...
   public void Kit()
   {
    ...
    {
        dstryed++;
        helicopterDestroyed.text=": "+ dstryed;
    }
    public void over()
    {
        follow=false;
